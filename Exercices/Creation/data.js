...
var doctor2 = extend(new Doctor('foo', 'bar', 21, 'gender', 'Pediatrics'), professional);
console.log(doctor instanceof Person);     // logs true
console.log(doctor instanceof Doctor);     // logs true
doctor.eat();                              // logs 'Eating'
doctor.communicate();                      // logs 'Communicating'
...
doctor2.invoice();                          // logs 'foo bar is Billing customer'
doctor2.payTax();                           // logs 'foo bar Paying taxes'

professional.invoice = function() {
  console.log(this.firstName + ' ' + this.lastName + ' is asking customer to pay');
};

doctor2.invoice();                          // logs 'foo bar is Asking customer to pay'
